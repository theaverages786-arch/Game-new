  ...
  const gamesShowcase = [
    {
      id: 'slots_super_ace',
      title: 'Super Ace 777',
      category: 'JILI Cards Elimination',
      badge: 'HOT 🔥',
      image: '♠️',
      bgGradient: 'from-amber-600 to-yellow-500',
      multiplier: 'x5 Multiplier + Wilds',
      players: '14,450 Playing',
    },
    {
      id: 'crash_aviator',
    ...
    },
    {
      ...
      title: 'Fortune Gems 777',
      category: 'JILI Multiplier Wheel',
      badge: 'JACKPOT 💎',
      image: '💎',
      bgGradient: 'from-emerald-600 to-teal-500',
      multiplier: '15x 4th Reel',
      players: '11,200 Playing',
    },
    {
      id: 'cards_teen_patti',
      title: 'Teen Patti 3-Card',
      category: 'Classic Card Poker',
      badge: 'PK FAVORITE 🎴',
      image: '🎴',
      bgGradient: 'from-green-600 to-emerald-500',
      multiplier: 'Pure Sequence 10x',
      players: '13,500 Playing',
    },
    {
      id: 'cards_andar_bahar',
      title: 'Andar Bahar Live',
      category: 'Live Card Match',
      badge: 'LIVE 🃏',
      image: '🃏',
      bgGradient: 'from-blue-600 to-indigo-500',
      multiplier: 'Instant 2.0x',
      players: '9,800 Playing',
    },
    {
      id: 'fishing_ocean_king',
      title: 'Fish Hunter 777',
      category: 'Ocean King Arcade',
      badge: 'BIG BOSS 🐠',
      image: '🐠',
      bgGradient: 'from-cyan-600 to-blue-500',
      multiplier: '100x Boss Dragon',
      players: '12,100 Playing',
    },
    {
      id: 'color_wingo',
    ...
    },
    {
      ...
      players: '8,600 Playing',
    },
    {
      id: 'arcade_plinko',
      title: 'Plinko Ball Drop',
      category: 'Peg Multipliers',
      badge: 'FUN 🔴',
      image: '🔴',
      bgGradient: 'from-pink-600 to-rose-500',
      multiplier: '10x Bucket Hit',
      players: '7,400 Playing',
    },
  ];
